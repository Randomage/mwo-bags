...
5543
   23432  `)
    ...
    it("returns unknown rewards for lines containing non-reward strings", () => {
        expect(parseRewardString("notAReward")).toEqual(
            List<Reward>([
                {
                    rawValue: "notAReward",
                    type: "Unknown"
    ...
    it("parses CBill rewards", () => {
        expect(parseRewardString("62,500 C-Bills")).toEqual(
            List<Reward>([
                {
                    type: "CBills",
                    amount: 62500
    ...
    it("parses MC rewards", () => {
        expect(parseRewardString("30 MC")).toEqual(
            List<Reward>([
                {
                    type: "MC",
                    amount: 30
    ...
    it("parses GXP rewards", () => {
        expect(parseRewardString("300 GXP")).toEqual(
            List<Reward>([
                {
                    type: "GXP",
                    amount: 300
    ...
    it("parses consumable rewards", () => {
        expect(parseRewardString("CBill Cool Shot")).toEqual(
            List<Reward>([
                {
                    type: "Consumables",
                    name: "Cool Shot"
    ...
    it("parses cockpit item rewards", () => {
        expect(parseRewardString("Cockpit Mounted - UrbanMech Warhorn")).toEqual(
            List<Reward>([
                {
                    type: "Cockpit Items",
    ...
    it("parses premium time rewards", () => {
        expect(parseRewardString("1 Day Active Premium Time")).toEqual(
            List<Reward>([
                {
                    type: "Premium Time"
                }
