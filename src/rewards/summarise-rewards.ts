...
export const summariseRewards:
    (type: RewardType, rewards: List<Reward>, calculateProportion: (count: number) => number) => RewardSummary =
    (type: RewardType, rewards: List<Reward>, calculateProportion: (count: number) => number) => {
